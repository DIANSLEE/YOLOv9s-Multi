...
from ..myblocks.iRMB import iRMB
...
class DFL(nn.Module):
    ...
    def __init__(self, c1=16):
        ...
        self.conv.weight.data[:] = nn.Parameter(x.view(1, c1, 1, 1))  # tensor形状为（1，16，1，1）从内到外的维度【【【【0.】】，【【1。】】】】从左到右是从外到内
        self.c1 = c1
...
class RepBottleneck(Bottleneck):
    ...
    def __init__(self, c1, c2, shortcut=True, g=1, k=(3, 3), e=0.5):
        ...
        # self.cv2 = iRMB(c_, c2, exp_ratio=e)  # 改动点 IRMB
