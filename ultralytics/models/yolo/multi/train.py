...
class MultiTaskTrainer(yolo.detect.DetectionTrainer):
    ...
    def get_validator(self):
        ...
        self.loss_names = ('box_loss', 'pose_loss', 'kobj_loss', 'seg_loss', 'cls_loss', 'dfl_loss')  # 改动点未改动，是否应该添加关键点的类别
        return yolo.multi.MultiTaskValidator(self.test_loader, save_dir=self.save_dir, args=copy(self.args), _callbacks=self.callbacks)
