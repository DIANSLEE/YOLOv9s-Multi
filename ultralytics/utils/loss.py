...
class v8DetectionLoss:
    ...
    def __init__(self, model, tal_topk=10):  # model must be de-paralleled
        ...
        self.nc = m.nc  # number of classes  改动点未改动，我觉得这里应该添加keypoints的class吧
        self.no = m.nc + m.reg_max * 4  # number of output channel
        self.reg_max = m.reg_max
        self.device = device

        self.use_dfl = m.reg_max > 1
  # 改动点 比如说这里可以设置如果是v8SegLoss传入nc是seg_class, key传入nc是key的这样比较好吧
